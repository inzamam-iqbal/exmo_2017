...
import com.moratuwa.exhibition.Adapters.SchedulePagerAdapter;
...
public class ScheduleActivity extends NavBar {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabLayout.addTab(tabLayout.newTab().setText("April 28"));
        tabLayout.addTab(tabLayout.newTab().setText("April 29"));
